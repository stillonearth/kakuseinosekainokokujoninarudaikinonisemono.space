<script lang="ts">
  ...
  function setActiveSection(section: any) {
    activeSection.update(value => section);
  }
</script>
  ...
  <div class="max-w-7xl mx-auto">
    <div class="flex flex-col items-center text-center mb-6">
      <h1 class="text-3xl md:text-4xl font-bold text-purple-400 mb-4 px-4">
        An Epic Quest for Destiny in the Hidden Realms of Deception and
    ...
    <div class="flex justify-between items-center">
      <div class="flex space-x-6">
        <a
          ...
          on:click={() => setActiveSection("game")}>Game</a
        >
        <a
          href="#collection"
          class="text-gray-300 hover:text-purple-400"
          class:active={$activeSection == 'game'}
          on:click={() => setActiveSection("nfts")}>Collection</a
        >
        <a
          href="#news"
          class="text-gray-300 hover:text-purple-400"
          class:active={$activeSection == 'game'}
          on:click={() => setActiveSection("news")}>News</a
        >
        <a
          href="#rules"
          class="text-gray-300 hover:text-purple-400"
          class:active={$activeSection == 'game'}
          on:click={() => setActiveSection("rules")}>Rules</a
        >
      </div>
